    ...
    <div class="jumbotron" id="tc_jumbotron">
      <div class="card-body" id="xx" style="color: #fff;     border:1px solid #fff;">
        <div class="text-center">
          <h1 style="font-size: 3.5rem;">ФОРУМ</h1>
          <p>Благодаря форуму можете получить ответы на интересующие вас вопросы.</p>
        </div>
      </div>
    </div>
  </div>
                  ...
                  <tr>
                    <td width="453">
                      <div class="forum_title">
                        <h4><a href="{{route('forumslug', $forum->slug)}}">{{ str_limit($forum->title, 38) }}</a></h4>
                        <p>{{ str_limit(strip_tags($forum->description, 52)) }}</p>
                    ...
                    <td style="text-align: center">
                      <small> {{ $forum->comments->count() }}</small>
                    </td>
                    <td style="text-align: center">
                      <small> {{ $forum->getViews() }}</small>
                    </td>
                    <td>
                      <div class="forum_by">
