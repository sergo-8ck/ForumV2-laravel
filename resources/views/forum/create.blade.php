                        ...
                        <div class="card-body">
                            <form action="{{route('forum.store')}}" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" id="tc_input" class="form-control" name="title" placeholder="Title" required>
                                </div>
                                ...
                                <div class="des">
                                    ...
                                    <div id="description-textarea" class="collapse">
                                        <div class="bg">
                                            <div class="form-group">
                                                <textarea type="text" class="form-control" id="tc_input" name="description" placeholder="description" required> </textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
