        ...
        <div class="card" id="tc_paneldefault" style="background: #f9f9f9;">
          <div class="card-body" id="tc_panelbody">
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body" style="background: #f9f9f9;">
                    <div class="forum_info">
                      ...
                      |
                      <small>Просмотров: {{$forums->getViews()}}</small>
                      |
                      <small>Ответов: {{ $forums->comments->count() }}</small>
                      |
                      ...
                      <div class="panel-body" style="    border-top: 1px solid #eee;">
                        <form action="{{route('replyComment', $comment->id)}}" method="post"
                          ...
                          <div class="form-group">
                            <input type="text" name="content_body" class="form-control" id="input_reply"
                ...
                <div class="panel panel-default" style="background-color: #f9f9f9;">
                  <div class="panel-body">
                    <div class="add_comment">
                      ...
                      @guest
                        <div class="comment-show" id="commenteee">
                          <p><a href="{{route('login')}}"><i class="fa fa-sign-in" aria-hidden="true"></i>
                              Авторизируйтесь,</a> чтобы добавить комментарий.</p>
                        </div>
                      @else
                        <div class="comment-show">
                          <form action="{{ route('addComment', $forums->id) }}" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                              <input type="text" name="content_body" id="Your-Answer" placeholder="Your Comment:"
                                     required="required">
              ...
              <div class="col-md-4">
                <a href="{{route('forum.create')}}" class="btn btn-success btn-block">Создать вопрос</a><br>
